...
if(isset($_POST['name']) && isset($_POST['phone']) && isset($_POST['email']) && isset($_POST['add'])){
    ...
    while($row = mysqli_fetch_assoc($query)){
        ...
        <tr>
            ...
            <td width="10%">'.$sl.'</td>
            <td width="20%">'.$thanhTien.' đ</td>
        </tr>
        ';
    }
    $emailHTML .= '
        <tr>
        <td colspan="2" width="70%"></td><td width="20%"><b><font color="#FF0000">'.$total.'đ</font></b></td>
        </tr>
        </table>
        <p>
...
try {
    ...
    $mail->Username   = 'tuanphan7396@gmail.com';                     // SMTP username
    $mail->Password   = 'hazsgrusvjznjwdu';                               // SMTP password
    $mail->SMTPSecure = 'tls';         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` also accepted
    $mail->Port       = 587;                                    // TCP port to connect to
    //Recipients
    $mail->setFrom('tuanphan7396@gmail.com', 'VietproShop');
    $mail->addAddress($email, 'Khách hàng');     // Add a recborn\ipient
    //$mail->addAddress('ellen@example.com');               // Name is optional
    //$mail->addReplyTo('info@example.com', 'Information');
    // $mail->addCC('tuanlt.hust@gmail.com');
