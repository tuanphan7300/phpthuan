...
?>
                ...
                <div id="product">
                    ...
                    <div class="fb-comments" data-href="http://localhost/phpk177/vietpro_mobile_shop/index.php?page_layout=product&prd_id=<?php echo $row['prd_id']; ?>" data-width="500" data-numposts="5"></div>
                    <!--	End Comments List	-->
                </div>
                <!--	End Product	--> 
