<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        if ($user_pass != $user_re_pass){
            $repassErrorMsg = "Mật khẩu bạn vừa nhập lại không khớp";
        }else{
            $sql = "UPDATE user  
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="col-md-8">
                                ...
                                <?php if(isset($repassErrorMsg)){echo '<div class="alert alert-danger"> Mật khẩu không khớp !</div>' ;}?>
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="user_pass" required value="<?php echo $row['user_pass']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Nhập lại mật khẩu</label>
                                    <input type="text" name="user_re_pass" required value="<?php echo $row['user_re_pass']; ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Quyền</label>
                                    <select name="user_level" class="form-control">
                                        <option <?php if($row['user_level']==1){echo 'selected';} ?> value=1>Admin</option>
                                        <option <?php if($row['user_level']==2){echo 'selected';} ?> value=2 selected>Member</option>
                                    </select>
                                </div>
