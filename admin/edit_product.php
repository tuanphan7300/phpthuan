<?php
    ...
    if(isset($_POST['sbm'])){
        ...
        $prd_accesssories = $_POST['prd_accessories'];
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cat_id" class="form-control">
                                        ...
                                        ?>
                                        <option <?php if($row_cat['cat_id']==$row_cat['cat_id']){echo 'selected';} ?> value=<?php echo $row_cat['cat_id'] ?>><?php echo $row_cat['cat_name'] ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
